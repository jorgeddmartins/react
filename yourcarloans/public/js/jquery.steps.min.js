...
$(document).ready(function() {
    var endButton = $("#endButtonName").text();
    var endButtonName;
    if (endButton === '') {
        endButtonName = 'Finish';
    } else {
        endButtonName = endButton;
    }
    ...
    ! function(a, b) {
        ...
        function G(a, b) {
            var c = i(a);
            a.bind("canceled" + c, b.onCanceled), a.bind("contentLoaded" + c, b.onContentLoaded), a.bind("finishing" + c, b.onFinishing), a.bind("finished" + c, b.onFinished), a.bind("init" + c, b.onInit), a.bind("stepChanging" + c, b.onStepChanging), a.bind("stepChanged" + c, b.onStepChanged), b.enableKeyNavigation && a.bind("keyup" + c, z), a.find(".actions a").bind("click" + c, C), a.find(".actions a").bind("keyup" + c, C)
        }
        ...
        function L(a, b, c) {
            if (b.enablePagination) {
                var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                    e = '<li><a type="submit" href="#{0}" role="menuitem">{1}</a></li>',
                    ee = '<li><a type="submit" id="nextItem" href="#{0}" role="menuitem">{1}</a></li>',
                    f = "";
                b.forceMoveForward || (f += e.format("previous", b.labels.previous)), f += ee.format("next", b.labels.next), b.enableFinishButton && (f += ee.format("finish", b.labels.finish)), b.enableCancelButton && (f += e.format("cancel", b.labels.cancel)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
            }
        }
