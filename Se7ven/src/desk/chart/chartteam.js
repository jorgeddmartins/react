...
class Chartteam extends Component {
		...
		$.fn.Chteams = () => {
			...
			class PChartTeams {
			    ...
			    constructor(id, options){
			        ...
			        this.#containerT = $(`#${this.id}`)
			        this.#containerT.append(templateT)
			        this.#containerT.addClass('pchart pc-container')
			        this.#chartSvg = this.#containerT.children('.pc-chart')
			        this.#chartText= this.#containerT.children('.pc-text')
			        this.render()
			    }
			    get id(){
			        return this.#id;
	        ...
	        let chart = new PChartTeams("containerT", options)
	    }
	    $(document).Chteams();
	}
