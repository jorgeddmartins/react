...
class Data extends React.Component {
	...
	componentDidMount() {
		...
		const AppCompo = () => {
            ...
            if(window.location.href === 'http://localhost:3001/#/desk' 
                || window.location.href === 'http://se7ven.jorgedd.com/#/desk' 
                || window.location.href === 'http://localhost:3000/#/desk' 
                || window.location.href === 'http://localhost:3000/#/settings' 
                || window.location.href === 'http://localhost:3001/#/settings' 
                || window.location.href === 'http://se7ven.jorgedd.com/#/settings' 
                || window.location.href === 'http://se7ven.jorgedd.com/#/createteam' 
                || window.location.href === 'http://localhost:3000/#/createteam' 
                || window.location.href === 'http://localhost:3001/#/createteam') {

                $('.backImg, .loadElm').detach();   
            }
        }
        AppCompo();


		const Se7venApp = (sOption) => {
