...
var publicSpreadsheetUrl = 'https://docs.google.com/spreadsheets/d/1nlhwlvPC65Kqj3NvRSwyWQSGaSLkVp8Iui4DkKz9oG4/edit?usp=sharing';
function init() {
    Tabletop.init( { 
...
function showInfo(data, tabletop) {
    data.forEach(function(data) {
        ...
        paragraph.innerHTML = data.Subheadline;
        
        mobilehome.src = data.mobile;
        desktophome.src = data.desktop;

    });
}
window.addEventListener('DOMContentLoaded', init);

var portfolioUrl = 'https://docs.google.com/spreadsheets/d/1a65zsccPP7XYnTCHVJK56xusYj3eMxTsqxMyvjA1Z9c/edit?usp=sharing';
function initport() {
    Tabletop.init({ 
        key: portfolioUrl,
        callback: showport,
...
function showport(data, tabletop) {
    data.forEach(function(data) {

        headerport.innerHTML = data.Headline;
        paragraphport.innerHTML = data.Subheadline;
        
        mobileport.innerHTML = data.mobile;
        desktoport.innerHTML = data.desktop;

    });
}
window.addEventListener('DOMContentLoaded', initport);

var aboutUrl = 'https://docs.google.com/spreadsheets/d/1-fLhPrk8BkprwcOu7ksv2c_ASR1iyW4tHba2itrMSow/edit?usp=sharing';
function initabout() {
    Tabletop.init({ 
        key: aboutUrl,
        callback: showabout,
...
function showabout(data, tabletop) {
    data.forEach(function(data) {

        headerabout.innerHTML = data.Headline;
        paragraphabout.innerHTML = data.Subheadline;
        
        mobileabout.innerHTML = data.mobile;
        desktopabout.innerHTML = data.desktop;
